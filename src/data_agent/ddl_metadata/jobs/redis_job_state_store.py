...
from data_agent.ddl_metadata.jobs.job_scripts_store import JobScriptsStore
from data_agent.ddl_metadata.jobs.redis_base_store import RedisBaseStore
from data_agent.ddl_metadata.models import DDLJobRequest, JobError, JobRecord, JobStatus
...
class RedisJobStateStore:
    ...
    def __init__(self, redis: Redis, keys: JobKeysStore) -> None:
        """绑定 Redis 客户端与任务键空间。"""
        self._redis = redis
        self._keys = keys
    ...
    async def get(self, job_id: str) -> JobRecord:
        ...
        return JobCodecStore.project(cast(Mapping[str, str], values))

...
def test_conversation_application_has_no_concrete_infrastructure_imports() -> None:
    ...
    root = Path("src/data_agent/conversation/application")
    forbidden = (
        "data_agent.infrastructure",
        "data_agent.memory.mysql",
        "sqlalchemy",
        "data_agent.settings",
    )
    violations: list[str] = []
...
def test_memory_application_has_no_concrete_adapter_imports() -> None:
    ...
    root = Path("src/data_agent/memory/application")
    forbidden = (
        "data_agent.infrastructure",
        "data_agent.memory.adapters",
        "data_agent.memory.indexing",
        "data_agent.memory.mysql",
        "data_agent.settings",
        "elasticsearch",
        "huggingface_hub",

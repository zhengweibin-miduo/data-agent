...
from data_sync.models import BinlogCoordinate, RowOperation
...
def test_capture_enforces_limit_inside_rows_event(
    ...
    monkeypatch.setattr("data_sync.binlog.BinLogStreamReader", FakeStream)

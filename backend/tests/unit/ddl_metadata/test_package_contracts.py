...
from ddl_metadata.api.jobs import router as jobs_router
from ddl_metadata.api.memories import router as memories_router
from ddl_metadata.jobs.redis.scripts import JobScripts
from ddl_metadata.worker.lifecycle import shutdown, startup
